...
NFT generation &amp; minting code for 'Doners'

## Custom 'NFT Collection Engine'

What this engine does...

1. Image generation
2. Uploads our files and metadata to IPFS
3. Creates a (smart)contract
4. Mint NFTs

(Referenced: https://github.com/codeSTACKr/create-10k-nft-collection)
...
- `--start=1`
  - The start flag indicates the tokenId number to start minting from.
- `--end=100`
  - The end flag indicates the tokenId number to stop at.
...
- Including the `--start=1` and/or `--end=100` flags will reveal only the specified tokenId or range of tokenIds.
...
- Refreshes the listing for the specified tokenIds on OpenSea.
